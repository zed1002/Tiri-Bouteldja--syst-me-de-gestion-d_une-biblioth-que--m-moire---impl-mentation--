...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#067FDA" fill-opacity="1" d="M0,128L21.8,144C43.6,160,87,192,131,197.3C174.5,203,218,181,262,170.7C305.5,160,349,160,393,160C436.4,160,480,160,524,181.3C567.3,203,611,245,655,256C698.2,267,742,245,785,224C829.1,203,873,181,916,197.3C960,213,1004,267,1047,250.7C1090.9,235,1135,149,1178,117.3C1221.8,85,1265,107,1309,112C1352.7,117,1396,107,1418,101.3L1440,96L1440,0L1418.2,0C1396.4,0,1353,0,1309,0C1265.5,0,1222,0,1178,0C1134.5,0,1091,0,1047,0C1003.6,0,960,0,916,0C872.7,0,829,0,785,0C741.8,0,698,0,655,0C610.9,0,567,0,524,0C480,0,436,0,393,0C349.1,0,305,0,262,0C218.2,0,175,0,131,0C87.3,0,44,0,22,0L0,0Z"></path></svg></div>
<?php
...
<link rel="stylesheet" href="http://localhost/gestiondunebibliotheque\css/searchs.css">
  ...
  <img class="borrowimg" src="http://localhost/gestiondunebibliotheque/image/user search.GIF" alt="al">
</div> 
...
<br><br><br>
      ...
      <h1 class="heading-primary headingR-primary--main">update user     </h1>
    <br><br>
...
<img src="http://localhost/gestiondunebibliotheque/image/Setup-amico(1).svg" alt="al" >
</div>
  ...
  <table class="table">
    ...
    <tr>
      ...
      <td>
        ...
        <a href="updateuser.php?edit=<?php echo $row['id']; ?>" class="btn btn-info" name='edit'>Edit</a>
