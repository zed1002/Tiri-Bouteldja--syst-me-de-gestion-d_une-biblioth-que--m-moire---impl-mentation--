...
<section class="section-1">
  ...
  <form action="http://localhost/gestiondunebibliotheque/exemplaire/exemplaireR.php" method="POST" style="padding:5px;">
    
      <div class="searchbar-container">
          <h1 class="heading-primary heading-primary--main"> SEARCH JOURNAL </h1>
...
if (isset($_POST['srchusrbtn'])):
    ...
    if ( ($column == "" ||$column != "ref_r" && $column != "titre_r"  && $column != "emp" && $column != "annee_r" && $column != "nbrexp_r"&& $column != "prix")){
//default column
  $column = "ref_r";}
  if ($q==""){
echo "empty field";
...
<thead>
  ...
  <th>reference</th>
    ...
    <td><?php echo $row['ref_r'];?></td>
      ...
      <td>
      <td>
      <a href="http://localhost/gestiondunebibliotheque/exemplaire/exemplairej.php?addex=<?php echo $row['ref_r']; ?>" class="btn btn-info" name='addex'>Add copy</a>
