...
<section class="section-1">
  ...
  <form action="http://localhost/gestiondunebibliotheque/exemplaire/exemplaireform.php" method="POST" style="padding: 5px;">
...
<button class="btn dropbtnp" type="submit" name="srchusrbtn" style="background-color: purple;">
                        search 
                      </button>
    </section>
...
if($q!=""):
  ...
  <table class="table">
    ...
    <td><?php echo $row['ref'];?></td>
      ...
      <td>
      <a href="http://localhost/gestiondunebibliotheque/exemplaire/exemplaire.php?addex=<?php echo $row['ref']; ?>" class="btn btn-info" name='addex'>Add copy</a>
