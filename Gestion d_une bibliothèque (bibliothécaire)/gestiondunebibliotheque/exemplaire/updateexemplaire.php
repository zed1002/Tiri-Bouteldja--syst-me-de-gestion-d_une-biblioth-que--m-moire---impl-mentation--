...
$sql="SELECT * FROM exemplaire WHERE ref_exp=$ref_exp ";
...
if(isset($_POST['update'])){
 ...
 $sql="UPDATE exemplaire SET titre='$titre', auteur='$auteur', edi='$edi', ref_exp='$ref_exp', annee='$annee', ref_fk='$ref_fk', emp='$emp' where ref_exp=$ref_exp ";
$result=mysqli_query($bdd,$sql);
    if(!mysqli_query($bdd,$sql)){
        die('fail:' .$bdd->error);
...
<html>
  ...
  <div class="form-img" style="margin-top:5px; width: 400px;margin-left: 0;">
        <img src="http://localhost/gestiondunebibliotheque/image/Portfolio Update.GIF" alt="al">
      </div>
    ...
    <div >
        ...
        <h1 style="font-size:40px">Update book copy</h1>
        </div>
                ...
                <div class="field-label is-normal">
                  ...
                  <div class="field-body">
                    <div class="field">
                        ...
                        <input class="input" name="ref_exp" type="number" placeholder="reference" value="<?php echo $ref_exp;?>"  readonly required='required'>
