...
<section class="section-1">
  ...
  <form action="http://localhost/gestiondunebibliotheque/exemplaire/exemplaireM.php" method="POST" style="padding: 5px;">
    
      <div class="searchbar-container">
          <h1 class="heading-primary heading-primary--main"> SEARCH THESIS </h1>
...
<thead>
  <tr>
    ...
    <td><?php echo $row['ref_m'];?></td>
      ...
      <td>
      <a href="http://localhost/gestiondunebibliotheque\exemplaire/exemplaireth.php?addex=<?php echo $row['ref_m']; ?>" class="btn btn-info" name='addex'>Add copy</a>
