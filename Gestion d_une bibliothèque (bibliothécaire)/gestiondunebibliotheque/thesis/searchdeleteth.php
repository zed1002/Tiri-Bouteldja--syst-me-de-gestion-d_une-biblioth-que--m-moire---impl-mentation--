...
<?php include "../book/navigation.html"?>
  ...
  <form  method="POST">
      ...
      <div class="searchbar-container">
          <h1 class="heading-primary heading-primary--main"> DELETE THESIS </h1>
    ...
    <td><?php echo $row['ref_m'];?></td>
      ...
      $ref=$row['ref_m'];
        $query = "SELECT * FROM emprunt
          where ref_fk='$ref' and genre='memoire'";
          $result = mysqli_query($bdd,$query);
          if(mysqli_num_rows($result) == 0): ?>
        <a class="btn btn-info" name="delete" value="delete"  onClick="crnth(<?php echo $row['ref_m']; ?>)" > Delete </a>
        <?php endif;
      if(mysqli_num_rows($result) > 0): 
        echo "this thesis is borrowed "?>
